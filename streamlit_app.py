...
if not connection_string:
    st.error("Azure Storage connection string not found. Please set the environment variable 'AZURE_STORAGE_CONNECTION_STRING'.")
else:
    ...
    for col, blob_name, description in zip(cols, blob_names, descriptions):
        ...
        try:
            ...
            with col:
                st.image(image, width=300)  # Display the resized image
